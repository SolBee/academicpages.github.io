...
# Patents
1. 김의직, 강인혁, **이솔비**, 권정혁, "각 노드로부터 설정된 GTS 할당 정보를 기초로 GTS를 할당하는 DSME 네트워크 시스템의 동작 방법, 시스템, 및 각 노드의 GTS를 할당하는 전자 장치의 동작 방법," 출원번호: 10-2024-0133122 (2024.09.30)
1. 김의직, 강인혁, **이솔비**, 권정혁, "트래픽 부하에 따라 GTS 할당 간격을 설정하는 전자 장치의 동작 방법," 출원번호: 10-2024-0133121 (2024.09.30)
